...
global.anitav4 = process.env.BOT_NAME || "TSUMA-XD";
global.ownername = process.env.OWNER_NAME || "TSUMA";
global.packname = process.env.PACK_NAME || "TSUMA-XD";
global.author = process.env.AUTHOR || "TSUMA";
global.channelname = process.env.CHANNEL_NAME || "TSUMA";
